...
const Mobilekit = {
        ...
        Dark_Mode: {
            ...
            night_mode: { // Activate dark mode between certain times of the day
                ...
                start_time: 18, // Start at 20:00
                end_time: 6, // End at 07:00
            },
...
function testMode() {
    ...
    console.clear();
    console.log("%cMobilekit (v" + Mobilekit.version + ")", "font-size: 1.3em; font-weight: bold; color: #FFF; background-color: #FE9500!; padding: 14px 70px; margin-bottom: 16px;")
    ...
    function testModeInfo(value, msg) {
        console.log("%c|" + "%c " + msg + " : " + "%c" + value, "color: #444; font-size :1.2em; font-weight: bold;", "color: inherit", "color:#FE9500!; font-weight: bold;");
    }
